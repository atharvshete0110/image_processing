...
def mouse_event(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        cv2.putText(insights_image, f"Top Left: {starting_point}", (starting_point[0] + 10, starting_point[1] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
        cv2.putText(insights_image, f"Bottom Right: {ending_point}", (ending_point[0] + 10, ending_point[1] + 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
